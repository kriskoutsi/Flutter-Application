...
class MygenresWidget extends StatefulWidget {
  const MygenresWidget({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _MygenresWidget();
}

class _MygenresWidget extends State<MygenresWidget> {
  bool editMode = false;
  ...
  Widget _buildEditModeOff() {
    return ListView.builder(
        ...
        itemBuilder: (context, index) => ListTile(
              ...
              leading: Text(
                savedGenres.elementAt(index).genre,
              ...
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(
                        builder: (context) => GenreWidget(
                              curGenre: savedGenres.elementAt(index),
                            )))
                    .then((value) => setState(() {}));
              },
            ));
        ...
        itemBuilder: (context, index) => ListTile(
              ...
              trailing: Container(
                  ...
                  child: IconButton(
                      onPressed: () {
                        setState(() {
                          savedGenres.remove(savedGenres.elementAt(index));
                        });
                      },
